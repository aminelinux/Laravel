@extends('layouts.app')
@section('content')
    <h1 class="mb-2">Create Post</h1>    
    <hr class="mb-2">
<form action="{{route('Post.store')}}" method="POST"> 
    @csrf
    <div class="mb-6">
        <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Post Title</label>
    ...
    <button type="submit" name="Envoyer" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
</form> 
@endsection
